...
/* harmony import */ var src_style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8);
/* harmony import */ var webpack5_a__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);
...
var banner = new URL(/* asset import */ __webpack_require__(7), __webpack_require__.b);
console.log(banner);
console.log('style', src_style_scss__WEBPACK_IMPORTED_MODULE_2__.default);
var IndexView = function (props) {
    var _a = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('你好'), txt = _a[0], setText = _a[1];
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'loading' },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", { src: banner, alt: "", onClick: onTouchPic })));
};
