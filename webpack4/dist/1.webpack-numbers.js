...
})(window, function(__WEBPACK_EXTERNAL_MODULE_YLtl__) {
return (window["webpackJsonpwebpackNumbers"] = window["webpackJsonpwebpackNumbers"] || []).push([[1],{
...
module.exports = __WEBPACK_EXTERNAL_MODULE_YLtl__;
...
__webpack_require__.e(/* import() */ 2).then(__webpack_require__.t.bind(null, "RNo3", 7));
if (true) {
...
async function getComponent() {
  ...
  const { default: _ } = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(null, "YLtl", 7));
  console.log('await')
